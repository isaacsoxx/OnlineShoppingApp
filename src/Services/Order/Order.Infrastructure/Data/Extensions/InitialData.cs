...
/// <summary>
/// Internal access only, provides predefined data for order domain entities.
/// </summary>
internal class InitialData
{
  /// <summary>
  /// Provides a list of predefined [Customer] entities.
  /// </summary>
  ...
  /// <summary>
  /// Provides a list of predefined [Product] entities.
  /// </summary>
  ...
  /// <summary>
  /// Provides a list of predefined [RootOrder] entities.
  /// </summary>
  public static IEnumerable<RootOrder> RootOrdersWithItems
  {
    get
    {
      ...
      return new List<RootOrder> { order1, order2 };
    }
  }
}
