    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RootOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RootOrders_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_RootOrders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "RootOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
